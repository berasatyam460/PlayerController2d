...
namespace PinePie.PieTabs
{
    public static partial class Navigator
    {
        ...
        public static void SearchBarAndCreatorTabBtnCallbacks()
        {
            ...
            if (IsSearchBarOpen)
                OpenSearchBar(creatorTabBtn, splitter, searchBtn, AssetCreatorButtonArea);
            else
                CloseSearchBar(creatorTabBtn, splitter, searchBtn, AssetCreatorButtonArea, shortcutTabsArea);
        ...
        private static void CloseSearchBar(Button creatorBtn, VisualElement splitter, Button openSearchButton, ScrollView AssetCreatorButtonArea, ScrollView shortcutTabsArea)
        {
            if (isTwoColumnMode)
            {
        ...
        private static void OpenSearchBar(Button creatorBtn, VisualElement splitter, Button openSearchButton, ScrollView AssetCreatorButtonArea)
        {
            if (!isTwoColumnMode) openSearchButton.style.width = 20f;

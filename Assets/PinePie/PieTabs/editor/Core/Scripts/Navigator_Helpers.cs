...
namespace PinePie.PieTabs
{
    public static partial class Navigator
    {
        ...
        {
            if (type == null) type = Type.GetType("UnityEditor.ProjectBrowser, UnityEditor");

            if (EndRenamingMI == null) EndRenamingMI = type?.GetMethod("EndRenaming", BindingFlags.Instance | BindingFlags.Public);
